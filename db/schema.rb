...
ActiveRecord::Schema.define(:version => 20130403201103) do

  create_table "refinery_albums", :force => true do |t|
    t.string   "title"
    t.date     "date"
    t.integer  "photo_id"
    t.text     "summary"
  ...
  create_table "refinery_people_members", :force => true do |t|
    t.string   "name"
    t.integer  "year"
    t.integer  "photo_id"
    t.string   "voice"
  ...
  create_table "refinery_press", :force => true do |t|
    t.string   "quote"
    t.string   "source"
    t.string   "link"
    t.integer  "position"
